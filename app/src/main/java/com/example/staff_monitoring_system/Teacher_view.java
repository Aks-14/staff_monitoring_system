...
//            Intent SD=new Intent(Teacher_view.this,Student_details.class);
//            startActivity(SD);
//        }
        ...
        if(id == R.id.about_us){
            Intent intent=new Intent(Teacher_view.this,aboutus.class);
            startActivity(intent);
        }
        if(id == R.id.help){
            Intent intent2=new Intent(Teacher_view.this,help.class);
