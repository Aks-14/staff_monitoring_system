...
public class student_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        db = openOrCreateDatabase("sms.db", Context.MODE_PRIVATE, null);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.find_staff){
            Intent intent2=new Intent(student_Dashboard.this, Teacher_map_list.class);
            startActivity(intent2);
        }
        if(id == R.id.about_us){
            Intent intent=new Intent(student_Dashboard.this,aboutus.class);
            startActivity(intent);
        }
        if(id == R.id.help){
            Intent intent2=new Intent(student_Dashboard.this,help.class);
            startActivity(intent2);
        }
        if(id == R.id.logout){
            finish();
